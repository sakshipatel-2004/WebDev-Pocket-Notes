    ...
    <div className=" bg-neutral-300 dark:bg-neutral-800 dark:text-white ">
      <div className=" flex flex-col md:flex-row px-3 md:space-x-2 py-5  m-auto   md:max-w-2xl | lg:max-w-4xl | xl:max-w-6xl ">
        ...
        <div className="my-5 mx-2 flex-1 space-y-3">
          ...
          <p className="pl-1">
            Phone :{" "}
            <a className="opacity-70 hover:opacity-100 text-sm" href="tel:9920565573">
              9920565573
            </a>{" "}
          </p>
          <p className="pl-1">
            Email :{" "}
            <a className="opacity-70 hover:opacity-100 text-sm" href="mailto:patelsakshi.2609@gmail.com">
              patelsakshi.2609@gmail.com
            </a>{" "}
          </p>
          <div className=" pl-1 flex space-x-4">
            <a href="https://www.linkedin.com/in/sakshi-patel-343134259/" target="_blank" rel="noreferrer">
              <img className="dark:invert opacity-80 hover:opacity-100 " alt="Linkedin" src={linkedinSvg} />
            </a>
            <a href="https://github.com/sakshipatel-2004" target="_blank" rel="noreferrer">
